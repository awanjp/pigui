...
// Config
$server = array(
    'base' => 'http://192.168.137.219/',
    'cups' => 'htpp://192.168.137.219:631',
    'webcam' => 'http://192.168.137.219/cam/'
);
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        <nav class="mdl-navigation mdl-color--blue-grey-800">
          <a class="mdl-navigation__link" href="http://<?php echo "$serverIP" ?>">
            <i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">home</i>Home</a>
          <a class="mdl-navigation__link" href="http://<?php echo "$serverIP" ?>:631">
            <i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">print</i>Printer</a>
          <a class="mdl-navigation__link" href="http://<?php echo "$serverIP" ?>/cam">
            <i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">scanner</i>Webcam</a>
          <div class="mdl-layout-spacer"></div>
